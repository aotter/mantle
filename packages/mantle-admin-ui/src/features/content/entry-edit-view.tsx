...
import { HtmlWysiwygEditor } from "../editor/html-wysiwyg-editor";
...
function SchemaField({
  ...
  const widgetKind = stringFieldWidget(schema, widget);
    ...
    <div className="space-y-2">
      ...
      {readOnly ? (
        ...
        <HtmlWysiwygEditor
          ...
          onChange={setValue}
        />
      ) : widgetKind === "richtext" || widgetKind === "textarea" ? (
        <div data-string-editor={widgetKind}>
          <Textarea
            aria-label={label}
...
export function stringFieldWidget(
  schema: JsonSchema,
  widget: "textarea" | null,
): "input" | "textarea" | "markdown" | "html" | "richtext" {

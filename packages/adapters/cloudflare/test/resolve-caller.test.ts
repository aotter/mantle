...
describe("resolveCaller", () => {
  ...
  it("rejects legacy opaque Cloudflare OAuth tokens after authority convergence", async () => {
    const result = await resolveCaller(new Request("https://example.test/api/orders", {

...
import { runMantleUseCase } from "../src/mount/runMantleUseCase.js";
...
describe("runMantleUseCase", () => {
  ...
  it("uses the shared status mapping and redacts structured diagnostics", async () => {
  ...
  it("maps returned use-case failures instead of sending them as HTTP 200", async () => {

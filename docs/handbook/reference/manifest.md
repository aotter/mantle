...
| MCP tool names | `request_publish`, `unpublish_entry`, `archive_entry`, `delete_entry`, `create_media_upload`, `commit_media_upload`, `read_entry` | A Procedure that mangles to one of these is `MCP_TOOL_NAME_COLLISION`. |

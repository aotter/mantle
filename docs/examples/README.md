...
| [`host-cloud-project/`](./host-cloud-project/README.md) | Executable versioned Cloud build artifact with a View, ref handler and frontend asset | host | no | none | itself |

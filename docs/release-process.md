...
Completion requires the Core tag SHA, all thirteen npmjs/GPR packages, exact
...
released from the immutable tag. When `tag_exists` and all thirteen npmjs
